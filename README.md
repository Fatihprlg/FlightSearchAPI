Java Spring Boot API for searching and makin CRUD operations on Flights and Airports. You can find api docs at: http://localhost:8080/v3/api-docs and swagger ui at http://localhost:8080/swagger-ui/index.html
Swagger Doc:
```
{
  "openapi": "3.0.1",
